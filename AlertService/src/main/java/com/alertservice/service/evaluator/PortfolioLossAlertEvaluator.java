...
@Component
public class PortfolioLossAlertEvaluator implements AlertEvaluator {

    @Override
    public AlertTypeEnum getType() {
        return AlertTypeEnum.PORTFOLIO_LOSS;
    }
    ...
    public Optional<AlertEvaluationResult> evaluate(AlertConfiguration config, AlertEvaluationInput input) {
        ...
        String message = "Portfolio %d loss exceeded %s%% (current: %s%%)".formatted(
